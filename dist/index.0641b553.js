...
/* Time */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _momentTimezone = require("moment-timezone");
var _momentTimezoneDefault = parcelHelpers.interopDefault(_momentTimezone);
function showTime() {
    document.getElementById("time").innerHTML = (0, _momentTimezoneDefault.default)().tz("Asia/Tokyo").format("HH:mm:ss");
}
setInterval(showTime, 1000);
/* Navigation */ const btnNav = document.querySelector("#btn-nav");
...
function showNav() {
    ...
    else boxNav.style.display = "block";
}
/* Theme */ const btnTheme = document.querySelector("#btn-theme");
...
const imgDark = new URL(require("93ebb77b904e2447"));
const imgLight = new URL(require("f5532efe23821912"));
let toggle = 1;
...
function toggleTheme() {
    if (toggle === 1) {
        if (document.querySelector("body.index") === null) styleA1.style = "background-color: black; color: white;";
        else styleA1.style = `background-color: black; background-image: url(${imgDark}); color: white;`;
        toggleDark();
        hoverLink("white");
    } else {
        if (document.querySelector("body.index") === null) styleA1.style = "background-color: white; color: darkslategray;";
        else styleA1.style = `background-color: white; background-image: url(${imgLight}); color: darkslategray;`;
        toggleLight();
...
},{"moment-timezone":"44wrF","93ebb77b904e2447":"3FOw9","f5532efe23821912":"lUm6F","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"44wrF":[function(require,module,exports) {
var moment = module.exports = require("c0c29274bc7d6330");
moment.tz.load(require("c4cae70ed46622ee"));

},{"c0c29274bc7d6330":"9vL8M","c4cae70ed46622ee":"cILxB"}],"9vL8M":[function(require,module,exports) {
//! moment-timezone.js
//! version : 0.5.43
...
(function(root, factory) {
    "use strict";
    /*global define*/ if (0, module.exports) module.exports = factory(require("ee59a8d6c7fd977c")); // Node
...
},{"ee59a8d6c7fd977c":"jwcsj"}],"jwcsj":[function(require,module,exports) {
//! moment.js
//! version : 2.29.4
...
},{}],"3FOw9":[function(require,module,exports) {
module.exports = require("91fc618b0a0d7907").getBundleURL("lPpKD") + "felix-fuchs-NanNLo5kt_Y-unsplash.70ade5ea.jpg" + "?" + Date.now();

},{"91fc618b0a0d7907":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"lUm6F":[function(require,module,exports) {
module.exports = require("bf84eb847b27f508").getBundleURL("lPpKD") + "victor-martin-6lI6YnLC9-k-unsplash.c6afe08e.jpg" + "?" + Date.now();

},{"bf84eb847b27f508":"lgJ39"}],"gkKU3":[function(require,module,exports) {
